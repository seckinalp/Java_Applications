...
public class Elves extends Characters{
    ...
    public Elves(int level, Humans rival, String clas)
    {
        super(level, rival);
        calculations();
        mp = hp - 10;
    ...
    public Elves(int level, Halflings rival, String clas)
    {
        super(level, rival);
        calculations();
        mp = hp - 10;
    ...
    public Elves(int level, Dwarfs rival, String clas)
    {
        super(level, rival);
        calculations();
        mp = hp - 10;
    ...
    public Elves(int level, Elves rival, String clas)
    {
        super(level, rival);
        calculations();
        mp = hp - 10;
    ...
    public void manaRestoreAbility()
    {
        temphp -= 2;
        tempmp += level * 2;
    }
    ...
    public void useAbility(int x)
    {
        ...
        else if(x == 3)
        {
            manaRestoreAbility();
            System.out.println();
            System.out.println("..Mana Restore..");
            System.out.println("Mana increse level x 2");
            System.out.println();
        }
        else if(x == 4)
        {
    ...
    public void displayAbilities()
    {
        ...
        for(int a = 0; a < abilities.size(); a++)
        {
            ...
            {   
                ...
                {
                    abilityName = "3 - Mana Restore Ability (Cost: 2 HP)";
                }
