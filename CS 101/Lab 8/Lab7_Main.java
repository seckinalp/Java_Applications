...
public class Lab7_Main {
    ...
    public static void part3Test() {
        ...
        player1.showAll();
        comparedPlayer.showAll();

        System.out.println("Efficiency of " + player1.getName() + ": " + String.format("%.2f", player1.efficiencyCalculate()));
        System.out.println("Efficiency of " + comparedPlayer.getName() + ": " + String.format("%.2f", comparedPlayer.efficiencyCalculate()));
